...
const JDAForm = () => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            const response = await fetch('https://kugtde.zapto.org/JDA/', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                console.log('JDA submitted:', data);
                setShowPopup(false); // Hide popup after successful submission
                alert('JDA submitted successfully!');
                ...
                alert('Error submitting JDA. Please try again.');
            }
        } catch (error) {
