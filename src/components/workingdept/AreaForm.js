...
const AreaForm = () => {
    ...
    const handleConfirm = async () => {
        try {
            ...
            const response = await fetch('https://kugtde.zapto.org/AreaConversion/', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                console.log('AreaConversion submitted:', data);
                setShowPopup(false); // Hide popup after successful submission
                alert('AreaConversion submitted successfully!');
                ...
                alert('Error submitting AreaConversion. Please try again.');
            }
        } catch (error) {
