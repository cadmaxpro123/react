...
const SectorForm = () => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            const response = await fetch('https://kugtde.zapto.org/SectorSuperImpose/', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                console.log('SectorSuperImpose submitted:', data);
                setShowPopup(false); // Hide popup after successful submission
                alert('SectorSuperImpose submitted successfully!');
                ...
                alert('Error submitting SectorSuperImpose. Please try again.');
            }
        } catch (error) {
