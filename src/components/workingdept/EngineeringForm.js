...
const EngineeringForm = () => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            const response = await fetch('https://kugtde.zapto.org/EngineeringDrawing/', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                console.log('EngineeringDrawing submitted:', data);
                setShowPopup(false); // Hide popup after successful submission
                alert('EngineeringDrawing submitted successfully!');
                setFormData({
                    ClientName: '',
                    TotalArea: '',
                    KhasraNo: '',
                ...
                alert('Error submitting EngineeringDrawing. Please try again.');
            }
        } catch (error) {
