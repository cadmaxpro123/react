...
const UrbanForm = () => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            const response = await fetch('https://kugtde.zapto.org/UrbanPlanning/', {
                method: 'POST',
                headers: {
                ...
                <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="TotalArea"
                            value={formData.TotalArea} onChange={handleChange} className="form-input" placeholder="Enter Area" />
                    </div>
                    <div className="form-group">
